...
//  var layor = `<div class="outlayer"><div class="inlayer"><img src="${src1}" alt="" style="width:30%"><img src="${src2}" alt="" style="margin:0 10px, width:30%"><img src="${src3}" alt="" style="width:30%"><div class="text"><h2></h2><p class="p1" style="margin-top:90px">${desc1} </p><p class="p1">${desc2}</p><span></span><span></span></div></div></div>`
//     $('body').append(layor)
    $('.outlayer').css({
        position:'fixed',
